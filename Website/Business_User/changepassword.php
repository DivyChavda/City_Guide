...
<head>
        ...
        <title>Business_User | ChangePassword</title>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-inverse">
                <div class="panel-heading"> 
                   <h3 class="text-center m-t-10"> ChangePassword to <strong>Business_User</strong> </h3>
                </div> 
                ...
                <div class="panel-body">
					...
					<?php
						...
						{
							$rw = $con->query("select * from business_user where BusinessUserEmail ='".$_SESSION['business']."' and BusinessUserPassword ='".$_REQUEST["txtolderpass"]."'") or die(mysqli_error($con));
							
							if(mysqli_num_rows($rw) > 0)
							{
							if($_REQUEST['txtnewpass'] == $_REQUEST['txtconfopass'])
							{
								$res = $con->query("update business_user set BusinessUserPassword = '".$_REQUEST['txtnewpass']."' where BusinessUserEmail = '".$_SESSION['business']."'") or die(mysqli_error($con));
								if($res == true)
								{

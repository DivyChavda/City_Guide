...
<head>
        ...
        <title>Business_User | ForgetPassword</title>
                ...
                <div class="panel-body">
					...
					<?php
							if(isset($_REQUEST["btnforgot"]))
							{
								...
								$query=$con->query("select * from business_user where BusinessUserEmail='".$email."'") or die(mysqli_error());
								...
								if(mysqli_num_rows($query) > 0)
								{
									...
									$mail->Body = 'Dear '.$res["BusinessUserName"].' your password is: '.$res["BusinessUserPassword"];
									$mail->IsHTML(true);
									if(!$mail->Send()) 

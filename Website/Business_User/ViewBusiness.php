                                        ...
                                        <div class="row" style="overflow:scroll;">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
													...
													$res = $con->query("select * from business where BusinessUserIdFK = '".$uid."'") or die(mysqli_error($con));
													...
													?>
                                                        <tr>
															...
															<td><img src="BusinessIcons/<?php echo $row["BusinessProfilePicture"]; ?>" height="100" width="100"></td>
															<td><?php echo $row["BusinessLatitude"]; ?></td>
															<td><?php echo $row["BusinessLongitude"]; ?></td>
															<td><?php echo $row["BusinessStatus"]; ?></td>
															<td><a href="AddBusiness.php?update=<?php echo $row["BusinessId"]; ?>">Edit</a> | <a href="?delete=<?php echo $row["BusinessId"]; ?>">Delete</a></td>
                                                        </tr>
													<?php } ?>
                                                    </tbody>
													...
													<?php
														...
														{
															$result=$con->query("select BusinessProfilePicture from business where BusinessId='".$_REQUEST["delete"]."'");
															while($row1=mysqli_fetch_array($result))
															{
																$image1=$row1["BusinessProfilePicture"];
															}
															unlink("BusinessIcons//".$image1);
															$con->query("delete from business where BusinessId='".$_REQUEST["delete"]."'") or die(mysqli_error($con));
															echo "<script>alert('Record deleted..!!');window.location='ViewBusiness.php'</script>";
														}
													?>
                                            </div>
                                        </div>

                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="tile-stats white-bg"> 
                            <div class="status">
                                <h3 class="m-t-0 counter">
								<?php
								$rs=$con->query("select * from business_user") or die(mysqli_error($con));
								echo mysqli_num_rows($rs);
								?>
								</h3> 
                                <p>Total Number of Business User</p>
                            </div> 
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="tile-stats white-bg"> 
                            <div class="col-sm-8">
                                <div class="status">
                                <h3 class="m-t-15"><span class="counter">
								<?php
								$rs=$con->query("select * from business") or die(mysqli_error($con));
								echo mysqli_num_rows($rs);
								?>
								</span></h3> 

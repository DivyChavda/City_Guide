...
<head>
        ...
        <title>CityGuide | ViewCity</title>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
													...
													<tbody> 
													<?php
													$res = $con->query("select * from city") or die(mysqli_error($con));
													while($row = mysqli_fetch_array($res))
													{
													?>
                                                        <tr>
                                                            <td><?php echo $row["CityName"]; ?></td>
															<td><a href="AddCity.php?update=<?php echo $row["CityId"]; ?>">Edit</a> | <a href="?delete=<?php echo $row["CityId"]; ?>">Delete</a></td>
                                                        </tr>
													<?php } ?>
                                                    </tbody>
													...
													<?php
														...
														{
															$con->query("delete from city where CityId='".$_REQUEST["delete"]."'") or die(mysqli_error($con));
															echo "<script>alert('Record deleted..!!');window.location='ViewCity.php'</script>";
														}
													?>
                                            </div>
                                        </div>
